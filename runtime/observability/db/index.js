...
// Lazy-load sql.js WASM on first use
let SQL = null;
...
export async function createObservabilityDatabase(filename = "observability.db") {
    const sqliteConstructor = await getSQL();
    ...
    const sqlite = new sqliteConstructor.Database(dbBuffer);
