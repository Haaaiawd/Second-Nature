...
// Constants
// ───────────────────────────────────────────────────────────────
export const CHARACTER_SIGNAL_ALLOWED_SOURCE_FAMILIES = new Set([
    "evidence",
    "action",
    "routine",
    "character",
...
const BLOCKED_REDACTION_CLASSES = new Set(["credential_blocked", "prompt_blocked", "private_blocked"]);
...
// Public API
// ───────────────────────────────────────────────────────────────
export function normalizeCharacterRefreshInput(rawSignals, context) {
    ...
    for (const signal of rawSignals) {
        ...
        if (BLOCKED_REDACTION_CLASSES.has(signal.redactionClass) ||
