...
// Helpers
// ───────────────────────────────────────────────────────────────
function* flattenFrameText(frame) {
    const habits = frame.emergentHabits ?? [];
    ...
    if (frame.valuePosture) {
        const value = frame.valuePosture;
        yield {
    ...
    if (frame.relationshipPosture) {
        const rel = frame.relationshipPosture;
        yield {
    ...
    if (frame.expressionPosture) {
        const expr = frame.expressionPosture;
    ...
    const tensions = frame.growthTensions ?? [];
    ...
    const conflictNotes = frame.conflictNotes ?? [];
