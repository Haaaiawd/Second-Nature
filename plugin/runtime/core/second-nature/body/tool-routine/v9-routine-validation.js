 ...
 */
import { parseToolRoutineGuardSchema, } from "../../../../shared/types/v9-contracts.js";
// ───────────────────────────────────────────────────────────────
 ...
 */
export function inferCapabilitySideEffectClass(capabilityId) {
...
function maxOfTriggerCapabilities(triggerCapabilities, capabilityPattern) {
    const candidates = [];
 ...
 */
export function validateGuardSchema(guardSchemaJson, context) {
 ...
 */
export function parseRoutineSteps(stepsJson) {
    if (!stepsJson) {
 ...
 */
export function validateSandboxCompliance(stepsJson, guard) {
    ...
    for (const step of steps) {
        ...
        if (guard.allowedCapabilities.length > 0 &&
...
// ───────────────────────────────────────────────────────────────
export function routineSourceRef(routineId, label) {
    return { family: "routine", id: routineId, label };
}
export function ledgerSourceRef(ledgerId) {
