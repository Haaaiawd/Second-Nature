...
export const attentionSignal = sqliteTable(
  "attention_signal",
  {
...
export const activityThread = sqliteTable(
  "activity_thread",
  {
    id: text("id").primaryKey(),
  ...
  (table) => ({
    statusUpdatedAtIdx: index("activity_thread_status_updated_at_idx").on(
      table.status,
      table.updatedAt,
    ),
    originAttentionIdx: index("activity_thread_origin_attention_idx").on(
      table.originAttentionSignalId,
    ),
...
export const activityStep = sqliteTable(
  "activity_step",
  {
    id: text("id").primaryKey(),
  ...
  (table) => ({
    threadCreatedAtIdx: index("activity_step_thread_created_at_idx").on(
      table.threadId,
      table.createdAt,
    ),
...
export const proceduralProjection = sqliteTable(
  ...
  (table) => ({
    capabilityStatusIdx: index("procedural_projection_capability_status_idx").on(
      table.capabilityPattern,
      table.status,
    ),
  }),
);
...
export const toolRoutine = sqliteTable(
  "tool_routine",
  {
    id: text("id").primaryKey(),
    createdAt: text("created_at").notNull(),
...
export const selfContinuityCard = sqliteTable(
...
export const characterFrame = sqliteTable(
  "character_frame",
  {
    id: text("id").primaryKey(),
    createdAt: text("created_at").notNull(),
...
export const connectorEvolutionPlan = sqliteTable(
  ...
  (table) => ({
    platformStatusIdx: index("connector_evolution_plan_platform_status_idx").on(
      table.platformId,
      table.status,
    ),
  }),
...
export const connectorVersion = sqliteTable(
  "connector_version",
  {
    id: text("id").primaryKey(),
    createdAt: text("created_at").notNull(),
  ...
  (table) => ({
    platformVersionIdx: index("connector_version_platform_version_idx").on(
      table.platformId,
      table.versionId,
    ),
...
export const autonomousChangeLedger = sqliteTable(
  ...
  (table) => ({
    targetStatusIdx: index("autonomous_change_ledger_target_status_idx").on(
      table.targetId,
      table.status,
    ),
...
export const routineExecutionTrace = sqliteTable(
