...
const IMPULSE_TEXT: Record<Exclude<GuidanceSceneType, "explain" | "user_reply">, string> = {
...
export function getImpulseTemplate(sceneType: Exclude<GuidanceSceneType, "explain" | "user_reply">): ImpulseBlock {
  return {
    kind: sceneType,
