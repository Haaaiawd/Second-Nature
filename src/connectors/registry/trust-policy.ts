import {
  ...
  type ConnectorTrustStatus,
  type ConnectorRunnerKind,
 ...
 */
export function classifyTrust(manifest: ConnectorManifestV6): ConnectorTrustStatus {
  ...
  const kind: ConnectorRunnerKind = manifest.runner.kind;
 ...
 */
export function isExecutable(trustStatus: ConnectorTrustStatus): boolean {
